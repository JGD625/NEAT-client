...
export default class LearnWhiskey extends Component {
  render() {
    return (
   <div>
     <p>Whiskey (or whisky) is a type of distilled alcoholic beverage made from fermented grain mash. Popular grains, for whiskey making include barley, corn, rye, and wheat, and the grains may be malted depending on the type of whiskey being produced. Whiskey is typically aged in wooden casks, generally made of charred white oak. Casks previously used for production of other spirits, such as rum or sherry, are sometimes used to impart flavor.</p>
