...
export default class LearnRye extends Component {
  render() {
    return (
   <div>
     <p>Rye Whisky, often simply called Rye, is either an American Rye Whiskey or Canadian whisky, which is labeled for historical purposes and may not include rye in its production.</p> 
